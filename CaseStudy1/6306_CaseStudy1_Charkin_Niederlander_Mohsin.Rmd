...
This case study analyzes two files. One file contains information on breweries and another on beers. The goal is to merge the two files and do analysis of the data.Blah blah
...
```{r}
ABV<-tapply (merged$ABV, merged$State, median)
barplot(ABV, las=2, cex.names=0.7)

IBU<-tapply (merged$IBU, merged$State, median)
