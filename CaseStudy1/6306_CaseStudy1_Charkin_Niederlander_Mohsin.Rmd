...
We have been asked by the product development group at National Beverage Corporation to review the data for RelaxBev which they recently accquired. They have provided to us two files which contain information about the breweries and the beers produced within these facilities. They have asked that we provide them with information about the locations of the breweries, the median alcohol and bitterness units by state, the maximum levels of ABV/IBU, summary statistics, and the relationship between the bitterness of the beer and alcohol content. 

Based on this information, the product development team hopes to make some decisions about the integration of these breweries and beers into their current product offerings. Additionally, it will provide information about the current number of breweries to assess any overlap with their own facilities. 


###1. How many breweries are present in each state?

We have assessed that the current number of breweries span across most states with Colorado and California having the most facilities at 47 and 39 respectfully.  

Based on this list, there are three state that National Beverage Corporation currently do not have coverage. This includes: South Dakota, Washington DC, and Utah.  
...
Observations:
We've provided a snapshot of the data for your reference below. As you can see, the data included the Brewery Name, City, State, Name of the beer produced there, Beer ID, ABV and IBU. 
...
The chart below provides a histogram of the ABV and IBUs at the Median point by State. This overview by State shows that West Virginia has the highest median at 0.06 mL. The lowest median for ABV level is in Utah at 0.04 mL.  South Dakota has the lowest IBUs median with 0. The States with the highest median in IBU are Maine and West Virginia at +60 parts per million.
...
The scatter plot below does show evidence of an association with bitterness and alcohol content. As the bitterness units increases the alcohol content increases as well. This would suggest that the formula have a connection. 
